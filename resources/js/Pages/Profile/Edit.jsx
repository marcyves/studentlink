                    ...
                    <ProfileCard>
                        <header>
                            <h2 className="text-lg font-semibold text-on-surface">
                                {t('Domaines e-mail des cours')}
                            </h2>
                            <p className="mt-1 text-sm text-on-surface/60">
                                {t("Chaque cours conserve ses domaines. Si aucun domaine n'est renseigné, le domaine de votre adresse e-mail s'applique.")}
                            </p>
                        </header>

                        {courses.length === 0 ? (
                            <p className="mt-4 text-sm text-on-surface/70">
                                {t("Aucun cours pour le moment. Les domaines se règlent ici dès qu'un cours existe.")}
                            </p>
                        ) : (
